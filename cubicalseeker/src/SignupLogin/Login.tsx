...
const Login = () => {
    ...
    return<> <div className="w-1/2 px-20 flex flex-col justify-center gap-3">
            ...
            <div className="mx-auto">
                Don't have an account? <span className="text-sky-400 hover:underline cursor-pointer"  onClick={()=>{navigate("/login"); setFormError(form); setData(form)}}>Sign up</span>
            </div>
            <div onClick={open} className="text-sky-500 hover:underline cursor-pointer text-center">Forget Password?</div>
        </div>  
