    ...
    <div className="bg-mine-shaft-900 p-3 w-72 flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_blue] !shadow-sky-400">
      <div className="flex justify-evenly">
        ...
        profile.savedJobs.includes(props.id) ? (
          ...
          <IconBookmarkPlus
            onClick={handleSaveJob}
            className="text-mine-shaft-300 hover:text-sky-400 cursor-pointer"
            stroke={1.5}
          />
        )}
      </div>
      <div className="flex gap-2 [&>div]:py-1 [&>div]:px-2 [&>div]:bg-mine-shaft-800 [&>div]:text-sky-400 [&>div]:rounded-lg text-xs">
